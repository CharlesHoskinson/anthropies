...
PNG `tEXt`, JPEG APP11, and SVG `<metadata>` bytes that contain the ASCII
string `c2pa`. They are not copies of watermarks-remover (WR) MIT fixtures and
are not signed Claude Outputs.
