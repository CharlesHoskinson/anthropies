...
Sprint 0 T3. Encode fail-soft optional packs, fail-closed certification, size caps, and owner conflicts. Depends on `sprint0-kernel-strict-decode` archiving first.
